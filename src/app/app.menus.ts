...
import { CustomPageMenu } from './shared/menu/providers/custom-page.menu';
import { FaqPageMenu } from './shared/menu/providers/faq-page.menu';
import { ReportPageMenuProvider } from './shared/menu/providers/report-page.menu';
