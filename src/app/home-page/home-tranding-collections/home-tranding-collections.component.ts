...
declare var $: any;
@Component({
  selector: 'ds-home-tranding-collections',
  standalone: true,
  imports: [
    TranslateModule,
    CommonModule,
...
export class HomeTrandingCollectionsComponent {
  ...
  ngOnInit(): void {
    this.colorScheme = this.chartService.trendingCollectionsChartTheme ? this.chartService.trendingCollectionsChartTheme : 'air';
    this.loadData();
