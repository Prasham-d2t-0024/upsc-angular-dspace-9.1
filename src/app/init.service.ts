...
export abstract class InitService {
  ...
  public static providers(): Provider[] {
    ...
    return [
      ...
      {
        provide: APP_INITIALIZER,
        useFactory: (appImageConfigService: AppImageConfigService) => () => appImageConfigService.load(),
        deps: [ AppImageConfigService ],
        multi: true,
      },
      {
        provide: APP_INITIALIZER,
        useFactory: (featureConfigService: FeatureConfigService) => () => featureConfigService.load(),
