...
import { getCommunityCollectionPageRoute, getCommunityPageRoute } from '../../../community-page/community-page-routing-paths';
      ...
      map((browseDefListRD: RemoteData<PaginatedList<BrowseDefinition>>) => {
        ...
        if (browseDefListRD.hasSucceeded) {
          ...
          if (this.contentType === 'collection') {
            ...
            comRoute = getCommunityPageRoute(this.id);
            comColRoute = getCommunityCollectionPageRoute(this.id);
            allOptions.push({
              id: 'search',
              label: 'collection.page.browse.search.head',
              routerLink: `${comRoute}/search`,
            });
            allOptions.push({
              id: 'sub-com-col',
          ...
          allOptions.push(...browseDefListRD.payload.page.map((config: BrowseDefinition) => ({
            ...
            routerLink: `${comRoute}/browse/${config.id}`,
          })));
