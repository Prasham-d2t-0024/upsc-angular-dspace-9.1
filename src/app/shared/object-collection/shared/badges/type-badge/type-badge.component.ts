...
export class TypeBadgeComponent {
  ...
  @Input() set object(object: DSpaceObject) {
    this._object = object;
    this._dctype = this._object.allMetadataValues('dc.type');
  ...
  isItemBadge(typeMessage: string): boolean {
    return typeMessage != 'item.listelement.badge'
  }
