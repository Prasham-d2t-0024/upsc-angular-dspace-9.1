...
export class SearchComponent implements OnDestroy, OnInit {
  ...
  @Output("closeSidebar") closeSidebar1: EventEmitter<any> = new EventEmitter();
  @Output("openSidebar") openSidebar1: EventEmitter<any> = new EventEmitter();
...
resetFilters(): void {
  ...
  this.searchConfigService.getCurrentFrontendFilters().pipe(
    map((filters) => {
      Object.keys(filters).forEach((f) => filters[f] = null);
      return filters;
    }),
    take(1)
  ).subscribe((clearParams) => {
